...
Para que o <i>Product Owner</i> tenha sucesso, toda a organização deve respeitar as suas decisões, estas devendo ser visíveis no conteúdo e na priorização do <i>Backlog</i> do Produto.
